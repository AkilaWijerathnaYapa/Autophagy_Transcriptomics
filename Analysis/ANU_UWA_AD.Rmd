...
## gene info
```{r}
athal_gene <- read_delim("C:/Users/akila/OneDrive/Documents/R_Projects/Kallisto_OP/Analysis/Arabidopsis_thaliana.TAIR10.44.gff3",skip=13,delim='\t',col_names = F) %>%
              subset(X3 == "gene") %>%
...
tx2gene <- read_delim("C:/Users/akila/OneDrive/Documents/R_Projects/Kallisto_OP/Analysis/AtRTD2_19April2016.gtf", delim='\t', col_names = F) %>%
